...
⭐ 精选项目
      ...
      Star
      jiaowolian
      交我练是一个以AI个性化推荐为核心的刷题工具，通过动态学习路径、错题分析和拍照搜题等功能，帮助用户高效备考。其双模型设计既满足复杂场景需求，又兼顾响应速度与隐私性，适合在线教育平台中“精准提分”的场景需求。
      ⭐ 4
      avg-game
      —
      ⭐ 1
...
🔥 最近更新
      ...
      speech-to-text
      🟡 JavaScript
      Browser-based speech-to-text (Whisper) with model vendored in repo
      2026-07-20
      video
      🟠 Astro
      Video gallery built with Astro
      2026-07-20
      hh
      🟣 CSS
      Personal portfolio built with Astro (v4-inspired)
      2026-07-20
      tts
      🟠 Astro
      —
      ...
      Artemis
      ⚪ Other
      Openclaw+Local LLM+GPT-SoVITS+ComfyUI image+Live2D+desktop pet+SilllyTavern Character
      2026-06-21
      HiClaw
      ⚪ Other
      ...
      2026-06-19
📦 全部项目（158 个 · 按语言折叠）
  点击任意语言标题即可展开该分类下的全部仓库。
<b>🟠 Astro</b> · 3 个仓库（点击展开）
        项目
        简介
        ★
        ⑂
...
<b>⚪ Other</b> · 151 个仓库（点击展开）
        ...
        0
        IDA_GPT
        集成GPT或者deepseek免费API到IDA插件中，解释IDA反汇编代码，提高逆向效率，感谢各种免费资源。
        0
        0
        Imgbot
        ...
        0
        NJU-Business
        和商业相关的学科整理，涉及管理、金融、经济、偏互联网、职业介绍等方面内容。
        0
        0
        ...
        0
        nju_csai_kaoyan
        南京大学 计算机和人工智能 考研信息汇总 南京大学计算机考研
        0
        0
        NJUAI-Notes
        ...
        0
        NJUPT-CS-FREE
        南京邮电大学计软网安院学习资料。Covers all materials for CST, SE, and InfoSec majors.
        0
        0
        nocodefunctions-web-app
        The code base of the web app nocodefunctions.com
        0
        0
        noontiger
        ...
        0
        tidytuesday
        My contribution to the #TidyTuesday challenge, with the visualizations and code
        0
        0
        timemachineplus
        ...
        0
        translate-selection
        Manipulation, language translation and speak any html selection range on webpage using Goole Translate and Google TTS service on Chrome browser.
        0
        0
        TranslatorTool
        基于网页版彩云小译api实现翻译
        ...
        0
        zscat-me
        基于springboot  cloud构建的一个商城项目，包括前端，后端和h5应用，小程序，作为zscat应用实践的模板项目。基于SpringBoot2.x、SpringCloud和SpringCloudAlibaba并采用前后端分离的企业级微服务敏捷开发系统架构。并引入组件化的思想实现高内聚低耦合，[ 微信 + 支付宝 + 百度 + 头条 ] 小程序 + APP + 公众号 + PC + H5 项目代码简洁注释丰富上手容易，适合学习和企业中使用。真正实现了基于RBAC、jwt和oauth2的无状态统一权限认证的解决方案，面向互联网设计同时适合B端和C端用户，支持CI/CD多环境部署，积分商城，分销商城并提供应用管理方便第三方系统接入；同时还集合各种微服务治理功能和监控功能。模块包括:企业级
        0
        0
        zscat-me-uniapp-app-springcloud-
        基于springboot cloud构建的一个商城项目，包括前端，后端和h5应用，小程序，作为zscat应用实践的模板项目。基于SpringBoot2.x、SpringCloud和SpringCloudAlibaba并采用前后端分离的企业级微服务敏捷开发系统架构。并引入组件化的思想实现高内聚低耦合，[ 微信 + 支付宝 + 百度 + 头条 ] 小程序 + APP + 公众号 + PC + H5 项目代码简洁注释丰富上手容易，适合学习和企业中使用。真正实现了基于RBAC、jwt和oauth2的无状态统一权限认证的解决方案，面向互联网设计同时适合B端和C端用户，支持CI/CD多环境部署，积分商城，分销商城并提供应用管理方便第三方系统接入；同时还集合各种微服务治理功能和监控功能。模块包括:企业级的
        0
        0
🚀 想要更炫的浏览体验？
上面的折叠面板已把全部项目并入本页；如果你想要搜索 / 实时筛选 / 排序 / 明暗主题的完整交互版：
<p align='center'>
...
<div align='center'>
  <p><sub>⚡ 数据来自 GitHub REST API · 共 158 个公开仓库</sub></p>
</div>
